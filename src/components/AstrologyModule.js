...
export default function AstrologyModule({ setCurrentModule }) {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (q.includes('நிலம்') || q.includes('வீடு') || q.includes('மனை') || q.includes('சொத்து')) {
        reply = `உங்கள் 4-ஆம் பாவக அதிபதி மற்றும் குரு-சுக்கிர தசா சாதகமாக உள்ளதால், வடக்கு அல்லது கிழக்கு பார்த்த மனை வாங்குவது யோகத்தை தரும். 2026-ஆம் ஆண்டு இரண்டாம் பகுதி பத்திரப் பதிவுக்கு உகந்தது.`;
      } else if (q.includes('வேலை') || q.includes('தொழில்') || q.includes('உயர்வு') || q.includes('பதவி')) {
        reply = `கே.பி. கணிப்புப்படி உங்கள் 10-ஆம் பாவக உப நட்சத்திர அதிபதி வலுவான தொடர்பில் உள்ளார். தற்போதைய பணியில் உயர் பொறுப்புகளும், நிர்வாக அங்கீகாரமும் கிட்டும் வாய்ப்புகள் அதிகம்.`;
      } else if (q.includes('பரிகாரம்') || q.includes('வழிபாடு') || q.includes('கோயில்')) {
        reply = `உங்கள் அஸ்தம் நட்சத்திரத்திற்குரிய அத்தி மரக்கன்று நடுவது அல்லது பராமரிப்பது அதிர்ஷ்டத்தை ஈர்க்கும். காயத்ரி தேவி வழிபாடு மற்றும் சனிக்கிழமை எறும்புகளுக்கு பச்சரிசி ரவை வழங்குதல் தடைகளை நீக்கும்.`;
      } else if (q.includes('குழந்தை') || q.includes('கல்வி') || q.includes('பையன்') || q.includes('மகள்')) {
        reply = `குழந்தைகளுக்கு 5-ஆம் பாவக புத்தி ஸ்தானம் சிறப்பாக உள்ளது. தொழில்நுணுக்கம், கணிதம் அல்லது நிர்வாகத் துறைகளில் சிறந்த எதிர்காலம் அமையும்.`;
      } else {
        reply = `உங்கள் ஜாதகக் கணிப்புப்படி நடப்பு தசா-புக்தி பலம் 82% நற்பலன்களையே வழங்குகிறது. மனதில் நினைத்த காரியத்தைத் துணிந்து தொடங்கலாம்; குலதெய்வப் பிரார்த்தனை வெற்றியை உறுதி செய்யும்.`;
      }
